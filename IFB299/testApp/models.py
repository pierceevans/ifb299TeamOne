...
class Order(models.Model):
    ...
    pickup_store_id = models.IntegerField(db_column='Pickup_Store_ID')  # Field name made lowercase.
    return_store_id = models.IntegerField(db_column='Return_Store_ID')  # Field name made lowercase.
    order_create_date_id = models.IntegerField(db_column='Order_Create_Date_ID')  # Field name made lowercase.
    pickup_date_id = models.IntegerField(db_column='Pickup_Date_ID')  # Field name made lowercase.
    return_date_id = models.IntegerField(db_column='Return_Date_ID')  # Field name made lowercase.
...
class Vehicle(models.Model):
    ...
    car_make_key = models.IntegerField(db_column='Car_Make_Key', blank=True, null=True)  # Field name made lowercase.
